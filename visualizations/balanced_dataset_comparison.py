...
modalities = ["Chest X-Ray", "Mammo.", "Dermoscopy", "CT Scan", "Fundus",
              "Ultrasound", "MRI", "Pathology", "Overall"]
...
fig.update_yaxes(title_text="Accuracy", range=[0.5, 1], showgrid=True, gridwidth=0.5, gridcolor='lightgray', row=1, col=1)
fig.update_yaxes(title_text="F1 Score", range=[0, 1], showgrid=True, gridwidth=0.5, gridcolor='lightgray', row=2, col=1)
