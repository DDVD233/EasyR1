...
novel_task_datasets = [dataset for dataset in drpo_acc.keys()
                       if 'COVID' in dataset.upper() or 'CORONA' in dataset.upper()]

understudied_modality_datasets = [
    'BUSI', 'COVID-US', 'COVID-BLUES', 'KiTS23', 'CPSC', 'Chapman', 'Ga', 'PTB-XL',
    'CBIS-DDSM', 'VinDr Mammo'
]

understudied_location_datasets = [
    'PAD-UFES-20', 'COVID-BLUES', 'CPSC', 'Chapman', 'Fundus APTOS'
]
